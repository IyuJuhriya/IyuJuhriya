/**
 *Submitted Generations
*/

/*
   #CaribouSwap features:
...
contract CaribouSwap is Context, IERC20, Ownable {
    ...
    string private _name = "CaribouSwap";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x4460C9dFecdfAeF7E97c8068bC49B34116Ec51f8, 'We can not exclude Uniswap router.');
